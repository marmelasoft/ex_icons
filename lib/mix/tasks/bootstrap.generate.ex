defmodule Mix.Tasks.Bootstrap.Generate do
  @moduledoc """
  Generate Font Awesome components.

  1. Clone Font Awesome project.

      $ git clone https://github.com/twbs/icons.git icons-bootstrap

  2. Run the task.

      $ mix bootstrap.generate
  """
  use Mix.Task

  @shortdoc "Convert source SVG files into HEEX components. Run `git clone https://github.com/twbs/icons.git icons-bootstrap` first."
  def run(_) do
    src_path = "./icons-bootstrap/icons/"
    namespace = "Bootstrap"
    ...
    dest_path = "./lib/icons/bootstrap.ex"
