defmodule Icons.Ionicons.Sharp do
  ...
  def diamond(assigns) do
    ...
    ~H"""
    <svg class={@class} {@extra_attributes} id="icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  def create(assigns) do
    ...
    ~H"""
    <svg class={@class} {@extra_attributes} xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
