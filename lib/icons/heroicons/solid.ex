defmodule Icons.Heroicons.Solid do
  @moduledoc """
  ...
  def bars_3_bottom_right(assigns) do
    ...
    ~H"""
    <svg class={@class} {@extra_attributes} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
