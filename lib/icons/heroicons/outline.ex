defmodule Icons.Heroicons.Outline do
  @moduledoc """
  ...
  def bars_3_bottom_right(assigns) do
    ...
    ~H"""
    <svg class={@class} {@extra_attributes} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
